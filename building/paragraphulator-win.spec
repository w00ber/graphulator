...
"""
PyInstaller spec file for paragraphulator Windows executable.

Run with: python -m PyInstaller paragraphulator-win.spec
...
icon_path = project_root / 'misc' / 'paragraphulator.ico'
...
# Collect ALL PySide6 files (datas, binaries, hiddenimports) for QtWebEngine support
# QtWebEngine requires QtWebEngineProcess executable and resource files
try:
...
# Add PySide6 data files (QtWebEngine resources, etc.)
...
# Add PySide6 hidden imports (for QtWebEngine)
...
a = Analysis(
    ...
    excludes=[
        ...
        'ipykernel',
        'ipywidgets',
        'scipy',  # Not used directly - seaborn may work without it
        'test',
        'tests',
        'unittest',
        'pytest',
