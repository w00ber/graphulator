...
Pre-built macOS `.app` bundles and Windows `.exe` folders for both
**Graphulator** and **Paragraphulator** are attached to each tagged release.
Grab the one for your platform from the
[Releases page](https://github.com/w00ber/graphulator/releases) — no Python
install required.
